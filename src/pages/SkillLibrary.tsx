                  ...
                  onClick={async () => {
                    ...
                    if (installSource === "local" && selectedDirs.length > 1) {
                      ...
                      try {
                        ...
                        addToast(`${selectedDirs.length}/${selectedDirs.length} ${tc("messages.installSuccess")}`, "success");
                      } catch (e) {
                      ...
                      // Single install
                      await useAppStore.getState().installSkill(installSource, installInput.trim());
                    }
