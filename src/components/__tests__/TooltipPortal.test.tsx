...
describe('TooltipPortal', () => {
  it('returns null when open is false', () => {
    ...
    // createPortal always renders to document.body, but component returns null early
    expect(document.body.innerHTML).not.toContain('工具提示内容');
    // container should be empty since nothing rendered
  ...
  it('positions portal based on trigger rect and offsetY', () => {
    ...
    // top = rect.bottom + offsetY = 132 + 12 = 144
    expect(portalDiv?.getAttribute('style')).toContain('top: 144px');
    // left = rect.left + rect.width / 2 = 200 + 40 = 240
