...
describe('SortableSkillList', () => {
  it('renders empty state when skills array is empty', () => {
    render(
      <SortableSkillList skills={[]} onRemove={vi.fn()} onToggle={vi.fn()} />
    );
  ...
  it('renders skill items with names', () => {
    render(
      <SortableSkillList skills={mockSkills} onRemove={vi.fn()} onToggle={vi.fn()} />
    );
  ...
  it('calls onToggle when toggle button is clicked', () => {
    ...
    render(
      <SortableSkillList skills={mockSkills} onRemove={vi.fn()} onToggle={onToggle} />
    );
  ...
  it('calls onRemove when X button is clicked', () => {
    ...
    render(
      <SortableSkillList skills={mockSkills} onRemove={onRemove} onToggle={vi.fn()} />
    );
  ...
  it('does not show remove buttons when disabled', () => {
    render(
      <SortableSkillList skills={mockSkills} onRemove={vi.fn()} onToggle={vi.fn()} disabled={true} />
    );
  ...
  it('uses skill_id fallback when skill_name is falsy', () => {
    ...
    render(
      <SortableSkillList skills={[skillNoName]} onRemove={vi.fn()} onToggle={vi.fn()} />
    );
